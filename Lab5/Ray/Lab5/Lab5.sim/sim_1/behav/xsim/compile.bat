...
REM
REM Generated by Vivado on Tue May 05 17:15:14 +0800 2026
...
echo "xvlog --incr --relax -prj tb_mc_top_vlog.prj"
call xvlog  --incr --relax -prj tb_mc_top_vlog.prj -log xvlog.log
