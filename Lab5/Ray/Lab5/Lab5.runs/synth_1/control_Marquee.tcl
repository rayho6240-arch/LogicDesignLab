...
synth_design -top control_Marquee -part xc7z020clg400-1
...
write_checkpoint -force -noxdef control_Marquee.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file control_Marquee_utilization_synth.rpt -pb control_Marquee_utilization_synth.pb"  } 
