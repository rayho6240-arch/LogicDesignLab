...
REM
REM Generated by Vivado on Wed Apr 15 22:21:27 +0800 2026
...
echo "xvlog --incr --relax -prj tb_CLA_64_vlog.prj"
call xvlog  --incr --relax -prj tb_CLA_64_vlog.prj -log xvlog.log
