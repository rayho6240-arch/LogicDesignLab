...
REM
REM Generated by Vivado on Sun Mar 15 16:17:36 +0800 2026
...
echo "xvlog --incr --relax -prj lab2_9bits_encoder_tb_vlog.prj"
call xvlog  --incr --relax -prj lab2_9bits_encoder_tb_vlog.prj -log xvlog.log
