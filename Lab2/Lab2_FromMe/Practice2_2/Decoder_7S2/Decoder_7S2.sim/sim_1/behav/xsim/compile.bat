...
REM
REM Generated by Vivado on Sun Mar 15 12:14:03 +0800 2026
...
echo "xvlog --incr --relax -prj lab2_7S2_decoder_tb_vlog.prj"
call xvlog  --incr --relax -prj lab2_7S2_decoder_tb_vlog.prj -log xvlog.log
