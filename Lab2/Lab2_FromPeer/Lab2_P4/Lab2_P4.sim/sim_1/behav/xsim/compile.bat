...
REM
REM Generated by Vivado on Tue Mar 17 15:27:25 +0800 2026
...
echo "xvlog --incr --relax -prj lab2_top_15_2_tb_vlog.prj"
call xvlog  --incr --relax -prj lab2_top_15_2_tb_vlog.prj -log xvlog.log
