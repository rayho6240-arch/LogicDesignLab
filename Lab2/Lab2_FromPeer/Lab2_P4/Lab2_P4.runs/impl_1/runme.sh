...
HD_PWD='C:/logic system lab/Lab2/Lab2_P4/Lab2_P4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_15_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_15_2.tcl -notrace
