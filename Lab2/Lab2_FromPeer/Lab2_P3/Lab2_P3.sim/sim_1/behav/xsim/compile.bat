...
REM
REM Generated by Vivado on Tue Mar 17 00:21:55 +0800 2026
...
echo "xvlog --incr --relax -prj lab2_hex_15bits_encoder_tb_vlog.prj"
call xvlog  --incr --relax -prj lab2_hex_15bits_encoder_tb_vlog.prj -log xvlog.log
