...
REM
REM Generated by Vivado on Sun Apr 05 10:51:23 +0800 2026
...
echo "xvlog --incr --relax -prj Gated_D_Latch_tb_vlog.prj"
call xvlog  --incr --relax -prj Gated_D_Latch_tb_vlog.prj -log xvlog.log
