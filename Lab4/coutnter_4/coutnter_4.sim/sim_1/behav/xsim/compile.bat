...
REM
REM Generated by Vivado on Sun Apr 05 09:24:42 +0800 2026
...
echo "xvlog --incr --relax -prj counter_4_tb_vlog.prj"
call xvlog  --incr --relax -prj counter_4_tb_vlog.prj -log xvlog.log
