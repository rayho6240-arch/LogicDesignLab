...
REM
REM Generated by Vivado on Fri May 22 17:08:11 +0800 2026
...
echo "xvlog --incr --relax -prj tb_Speed_rainbow_breath_vlog.prj"
call xvlog  --incr --relax -prj tb_Speed_rainbow_breath_vlog.prj -log xvlog.log
