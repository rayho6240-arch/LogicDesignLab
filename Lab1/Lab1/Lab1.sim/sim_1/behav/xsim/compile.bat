...
REM
REM Generated by Vivado on Tue Mar 10 17:26:12 +0800 2026
...
echo "xvlog --incr --relax -prj tb_top_4_vlog.prj"
call xvlog  --incr --relax -prj tb_top_4_vlog.prj -log xvlog.log
